...
public class TerrainCreator : MonoBehaviour
{
    ...
    public GameObject Grass1, Grass2;

    private void Start()
    {
        // if (shape != null && edgeSprite != null)
        // {
        //     var spriteShape = shape.spriteShape;
        //     if (spriteShape != null)
        //     {
    ...
    private void SpawnGrass()
    {
        for (int i = 50; i < shape.spline.GetPointCount() - 1; i++)
        {
            ...
            if (randomNumber <= 50)
            {
                GameObject grassPrefab = randomNumber > 25 ? Grass1 : Grass2;

                // Instantiate and rotate grass to align with slope
                Instantiate(grassPrefab, point + new Vector3(0, 3f, 0), Quaternion.Euler(0, 0, angle));
            }
        }
    }
